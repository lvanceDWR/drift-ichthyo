...
catch <- read_csv("drift data/DriftCatchAccess_20240119.csv")
catch2 <- read_csv("drift data/DriftLabExcelData.csv")
samp <- read_csv("drift data/DriftSampAccess_20240119.csv")
samp2 <- read_csv("drift data/DriftSampExcelData.csv")
