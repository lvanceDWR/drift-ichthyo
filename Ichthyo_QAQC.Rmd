...
```
 ...
 Find unique values. Create data frame with water year and water type added in for analysis in QA/QC. \
```{r}
...
```{r}
SamplingQAQC_fill <- read.csv("R_write/IchSamplingQAQC_ Notated_.csv")
