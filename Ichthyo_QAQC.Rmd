...
IchExcelOverlap <- bind_rows(IchOverlapCatchA, IchExcelCatchA) %>%
  ...
  group_by(event_id, PhysicalDataID, Datetime, Date, Time, Station, YSI, WeatherCode,Tide, MicrocystisVisualRank,
           WaterTemperature, Secchi, Conductivity, SpCnd, pH, DO, Turbidity, FlowDirection, VegetationRank,
           ConditionCode, SamplingAltered,FieldComments_WQ, Flag_PQC, Comment_PQC, DataCorrectionComments, Year,
           Month, MonthAbb,MeterSetTime, FlowMeterStart, FlowMeterEnd, FlowMeterSpeed,MeshSize, FieldComments,
...
#find where multiple types of comments exist for one event_id before getting qaqc dataframe ready
...
write.csv(inv_final, paste0("R_write/Ichthyo/Ichthyo_data_", today, ".csv"), row.names = FALSE, quote = TRUE)
```
