...
28. Merge the two data frames together
```{r}
...
30. Summarize number of outliers flagged
```{r}
...
32. Plot before and after for SAMP
```{r}
...
33. Calculate Vol and CPUE, Vol_adj, CPUEAdj
```{r}
NetArea = 0.4572 * 0.25
...
34. Look at distribution of CPUE values
```{r}
...
36. Check on and change any known errors
```{r}
