...
#create an event_id for consistency across datasets and across databases 
...
6 Clean up sampling data from Excel to merge with lab data, then merge that dataframe with Phys data for complete data from Excel
```{r}
IchSampling <- Sampling2 %>%
  rename(Program = 'Measuring program short name',
         Date = 'Sampling Event Date',
...
```{r}
#combine sampling data with lab data
...
```
 ...
 filter Access data for dates that overlap with Excel
```{r}
